...
var require_react_dom_development = __commonJS({
  "node_modules/.pnpm/react-dom@19.2.4_react@19.2.4/node_modules/react-dom/cjs/react-dom.development.js"(exports) {
    ...
    "production" !== process.env.NODE_ENV && (function() {
      ...
      var React2 = __require("react"), Internals = {
        d: {
          f: noop,
          r: function() {
            throw Error(
...
function Counter() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: " flex justify-end rounded-xl p-4 border border-white/40 hover:rounded-2xl hover:border-dashed hover:bg-[hsl(193,46%,29%)]/5 transition-all duration-300 ", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col justify-between gap-2", children: [
      /* @__PURE__ */ jsx("p", { className: "uppercase text-xs font-mono font-medium border border-white/40 text-white w-fit px-2 py-1 rounded-2xl", children: "Counter" }),
      /* @__PURE__ */ jsx("span", { className: "text-6xl font-medium border-gray-300  text-white w-fit rounded-xl p-2", children: count })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: " relative md:h-full   flex flex-col items-center justify-between p-1 border border-gray-50/40 rounded-full ", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => {
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-0.5px opacity-40 z-0 absolute top-1/2 -translate-y-1/2 ", children: Array(30).fill(0).map((_, i) => /* @__PURE__ */ jsx("div", { className: "border-b border-white  w-5 h-0.5" }, i)) }),
      /* @__PURE__ */ jsx(
        Button,
        {
